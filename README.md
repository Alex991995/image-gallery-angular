...
Необходимо реализовать Angular приложение "Галерея изображений" по предоставленному дизайну из Figma. Пользователь может выбрать категорию изображений, искать изображения с помощью поисковой строки, сортировать изображения, добавлять изображения в избранное.
...
- Использование приватного удаленного репозитория;
...
2. **Страница с изображениями** - представляет собой страницу, на которой пользователь может искать изображения по названию. На данной странице показывается список изображений, с возможностью сортировки и добавления изображений в "Избранное":
   ...
   - Модальное окно должно закрываться при клике вне егообласти или по кнопке закрытия;
...
- **NgRx** - Для управления внутренним состоянием приложения;
